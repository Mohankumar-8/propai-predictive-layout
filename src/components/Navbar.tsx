...
const Navbar = () => {
  ...
  return (
    <header
      className={cn(
        "sticky top-0 z-50 bg-card/80 backdrop-blur-lg border-b border-border/50 transition-shadow duration-300",
    ...
    >
      ...
      <div
        ...
        className={cn(
          "fixed top-14 sm:top-16 right-0 z-50 h-[calc(100dvh-3.5rem)] sm:h-[calc(100dvh-4rem)] w-72 max-w-[85vw] bg-card border-l border-border/50 md:hidden transition-transform duration-300 ease-out",
